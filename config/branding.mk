...
INEXDROID_BUILD_VERSION = 13.0

# InexDroid Version
INEXDROID_VERSION := 1.5

# Custom Versioning
CUSTOM_VERSION := inexdroid-v$(INEXDROID_VERSION)-$(INEXDROID_BASE_VERSION)-$(CUSTOM_PLATFORM_VERSION)-$(CUSTOM_BUILD_DATE)-$(CUSTOM_BUILD)-$(CUSTOM_BUILD_TYPE)
