...
custom_default_revision = os.getenv('ROOMSERVICE_DEFAULT_BRANCH', 'tea')
custom_fallback_revision = 'thirteen'
uses_fallback_revision = False
custom_dependencies = "aosp.dependencies"
org_manifest = "inexdroid-devices"  # leave empty if org is provided in manifest
org_display = "InexDroid-Devices"  # needed for displaying
